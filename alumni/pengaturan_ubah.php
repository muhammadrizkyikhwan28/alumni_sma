<?php
	...
	$sql = "SELECT * FROM alumni WHERE nis ='". $sess_nis ."'";
					...
					<div class="col-lg-12">
							<div class="panel panel-default">
								<div class="panel-body">
									...
									<center>
									<img src="../foto/<?php echo $data['foto'];?>" width="250px">
									</center>
									</div>
								</div>
								<hr/>
							<form class="form-horizontal" action="pengaturan_ubah_update.php" method="POST" enctype="multipart/form-data">
								<div class="panel-body">
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="hidden" name="nis" class="form-control"  value="<?php echo $data['nis'] ?>" required>
